...
This creates a significant operational risk: research published in the \textit{Journal of Cybersecurity} has highlighted that cognitive load during high-stress incident response scenarios leads to procedural non-compliance, step skipping, and documentation gaps \citep{dutton2020}.
...
When analysts must manually follow PDF or wiki-based procedures during high-pressure incidents, cognitive load and time constraints routinely lead to steps being skipped, executed out of order, or left undocumented \citep{dutton2020}.
